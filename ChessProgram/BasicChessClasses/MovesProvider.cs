...
{
	public enum MoveResult { MoveOk, Castling, CapturedInPassing, 
	...
	public partial class MovesProvider
	{
		...
		{
			Change deleteChange = 
				new Change (MoveAction.Deletion, pawnCoords, FigureType.Pawn, player.FiguresColor);
			Change createChange = 
		...
		public virtual bool IsUnderPlayerControl (int coordsX, int coordsY, ChessPlayerBase player)
		{
			// initial coordinates
			int initX = coordsX;
			int initY = coordsY;
